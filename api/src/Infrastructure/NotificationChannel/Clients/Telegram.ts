...
import type NotificationChannelClient from '../../../Domain/NotificationChannel/Client/NotificationChannelClient'
...
export default class Telegram implements NotificationChannelClient {
  ...
  public static with (telegramBot: TelegramBotConfiguration): Telegram {
    return new Telegram(
      ...
      telegramBot.chat_id,
      telegramBot.topic_id !== undefined ? Number(telegramBot.topic_id) : undefined
    )
  }

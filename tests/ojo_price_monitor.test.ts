...
import { main } from '../src/ojo_price_monitor';
...
describe('Main', () => {
    ...
    it('should send a Telegram message if miss counter exceeds the tolerance', async () => {
        mock
            .onGet(`http://test-node:26657/ojo/oracle/v1/validators/TEST_VALOPER/miss`)
        ...
        expect(mock.history.get[0].url).toEqual(`http://test-node:26657/ojo/oracle/v1/validators/TEST_VALOPER/miss`);
